...
SUMMARY_CSV = OUTPUT_DIR / "bist_x1_growth_cooling_refine_summary.csv"
MONTHLY_CSV = OUTPUT_DIR / "bist_x1_growth_cooling_refine_monthly.csv"
README_MD = OUTPUT_DIR / "bist_x1_growth_cooling_refine_readout.md"
...
CANDIDATES = [
    CandidateSpec(name="baseline", notes="Current repaired accepted baseline."),
    CandidateSpec(
        name="x1cool_080_015_p10",
        notes="Current repaired winner from the first cooling retest.",
    ...
    CandidateSpec(
        ...
        notes="Slightly looser 60d threshold.",
        mode="x1_heavy_low_60d_penalty",
        share_threshold=0.80,
    ...
    CandidateSpec(
        name="x1cool_078_015_p10",
        notes="A touch more permissive x1 share trigger.",
        mode="x1_heavy_low_60d_penalty",
        share_threshold=0.78,
        return_60d_threshold=0.15,
        penalty_amount=0.10,
    ),
    CandidateSpec(
        name="x1cool_082_015_p10",
        notes="A touch stricter x1 share trigger.",
        mode="x1_heavy_low_60d_penalty",
        share_threshold=0.82,
        return_60d_threshold=0.15,
        penalty_amount=0.10,
    ),
    CandidateSpec(
        name="x1cool_080_017_p10",
        notes="Slightly looser 60d threshold around the winner.",
        mode="x1_heavy_low_60d_penalty",
        share_threshold=0.80,
        return_60d_threshold=0.17,
        penalty_amount=0.10,
    ),
    CandidateSpec(
        name="x1cool_080_013_p10",
        notes="Slightly tighter 60d threshold around the winner.",
        mode="x1_heavy_low_60d_penalty",
        share_threshold=0.80,
        return_60d_threshold=0.13,
        penalty_amount=0.10,
    ),
    CandidateSpec(
        name="x1cool_080_015_p08",
        notes="Lighter penalty around the winner.",
        mode="x1_heavy_low_60d_penalty",
        share_threshold=0.80,
        return_60d_threshold=0.15,
        penalty_amount=0.08,
    ...
    CandidateSpec(
        name="x1cool_080_015_p12",
        notes="Slightly stronger penalty around the winner.",
        mode="x1_heavy_low_60d_penalty",
        share_threshold=0.80,
        return_60d_threshold=0.15,
        penalty_amount=0.12,
...
def main() -> None:
    ...
    top = summary.iloc[0]
    lines = [
        "# BIST X1-Heavy Growth Cooling Refine",
        "",
