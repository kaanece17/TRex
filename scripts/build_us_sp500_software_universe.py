...
UNIVERSE_NAME = "US_LARGE_CAP_SOFTWARE"
USER_AGENT = "Mozilla/5.0 (compatible; TRex US software universe builder)"
OUTPUT_SYMBOLS = Path("/Users/kaanece/projects/TRex/data/universe/us_large_cap_software_symbols.csv")
OUTPUT_MEMBERSHIP = Path("/Users/kaanece/projects/TRex/data/universe/us_large_cap_software_membership.csv")


def _load_software_from_page(label: str, url: str) -> pd.DataFrame:
...
def main() -> None:
    ...
    combined = _load_software_from_page(label, url)
