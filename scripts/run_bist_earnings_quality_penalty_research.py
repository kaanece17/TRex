...
SUMMARY_CSV = OUTPUT_DIR / "bist_earnings_quality_penalty_summary.csv"
MONTHLY_CSV = OUTPUT_DIR / "bist_earnings_quality_penalty_monthly.csv"
README_MD = OUTPUT_DIR / "bist_earnings_quality_penalty_readout.md"


VARIANTS = [
    ("baseline", None, None, None, 0.0, "Current accepted baseline."),
    ("and_p05", "extreme_growth_and_accel_penalty", 3.1, 4.6, 0.05, "Penalty when both growth and acceleration are extreme."),
    ("and_p10", "extreme_growth_and_accel_penalty", 3.1, 4.6, 0.10, "Stronger penalty when both growth and acceleration are extreme."),
    ("or_p05", "extreme_growth_or_accel_penalty", 3.1, 4.6, 0.05, "Penalty when either growth or acceleration is extreme."),
]
...
def main() -> None:
    ...
    summary_rows = []
    monthly_frames = []
    for name, mode, max_yoy, max_accel, penalty, notes in VARIANTS:
        config = base_config.model_copy(deep=True)
        config.strategy.earnings_quality_soft_penalty_mode = mode
        ...
        config.strategy.earnings_quality_soft_penalty_amount = penalty
    ...
    lines = [
        "# BIST Earnings Quality Penalty Research",
        "",
