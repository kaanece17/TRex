...
SUMMARY_CSV = OUTPUT_DIR / "bist_earnings_tiebreak_summary.csv"
MONTHLY_CSV = OUTPUT_DIR / "bist_earnings_tiebreak_monthly.csv"
README_MD = OUTPUT_DIR / "bist_earnings_tiebreak_readout.md"
...
class CandidateSpec:
    name: str
    notes: str
    formula: str = "note_best_fit"
    earnings_weight: float = 0.0
...
CANDIDATES = [
    ...
    CandidateSpec(
        name="momentum_earnings_tb02",
        notes="Tiny earnings tie-break.",
        formula="note_best_fit_plus_earnings",
        earnings_weight=0.02,
    ),
    CandidateSpec(
        name="momentum_earnings_tb05",
        notes="Light earnings tie-break.",
        formula="note_best_fit_plus_earnings",
        earnings_weight=0.05,
    ),
    CandidateSpec(
        name="momentum_earnings_tb10",
        notes="Stronger earnings tie-break.",
        formula="note_best_fit_plus_earnings",
        earnings_weight=0.10,
    ),
    CandidateSpec(
        name="momentum_earnings_tb05_scorecap35",
        notes="Light earnings tie-break with score-cap weights.",
        formula="note_best_fit_plus_earnings",
        earnings_weight=0.05,
...
def main() -> None:
    ...
    top = summary.iloc[0]
    lines = [
        "# BIST Earnings Tie-Break Research",
        "",
