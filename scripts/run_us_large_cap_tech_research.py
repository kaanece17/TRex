...
SUMMARY_CSV = OUTPUT_DIR / "us_large_cap_tech_research_summary.csv"
MONTHLY_CSV = OUTPUT_DIR / "us_large_cap_tech_research_monthly.csv"
README_MD = OUTPUT_DIR / "us_large_cap_tech_research_readout.md"
...
CANDIDATES = [
    CandidateSpec(
        name="tech_quality_earnings",
        notes="Large-cap tech with full quality plus earnings sleeve.",
        formula="quality_plus_earnings",
    ),
    CandidateSpec(
        name="tech_quality_op_growth",
        notes="Large-cap tech with quality plus operating-profit growth sleeve.",
        formula="quality_plus_op_growth",
    ),
    CandidateSpec(
        name="tech_quality_op_growth_w15",
        notes="Large-cap tech with heavier operating-profit growth sleeve.",
        formula="quality_plus_op_growth",
        earnings_weight=1.5,
    ),
]
...
def main() -> None:
    ...
    baseline = summary.loc[summary["candidate"] == "tech_quality_earnings"].iloc[0]
    summary["strict_pass"] = (
    ...
    top = summary.iloc[0]
    lines = [
        "# US Large-Cap Tech PIT Research",
        "",
        "Universe choice:",
        "- Current static S&P 500 Information Technology membership.",
        "- Chosen as a higher-quality tech lane rather than broad small-cap tech.",
        "",
        f"- Baseline candidate: `tech_quality_earnings`",
